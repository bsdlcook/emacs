;;; minty-theme.el --- minty theme

;; Copyright (C) 2019, Lewis Cook
...
;;; Commentary:
;;
;;  Part of my system color scheme, but with a minty feel.

;;; Code:

(deftheme minty
  "Custom color scheme with a minty feel")
