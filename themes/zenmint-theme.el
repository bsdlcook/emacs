 ...
 (let ((class '((class color) (min-colors 89)))
       ...
       (keyword "#9DE3C0")
       (const   "#85ECD7")
       (comment "#EEE926") ;; Yellow comments.
       ;;(comment "#347E2C") ;; Green comments.
       (func    "#E1F4FF")
       (str     "#28B4A1")
       (type    "#ADE6B3")
       (var     "#E1F4FF")
   ...
   'zenmint
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,fg4 :background ,bg2)))) ;; fg4, bg2
